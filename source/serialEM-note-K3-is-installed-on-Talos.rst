...
#. I pre-odered extended 40 meter long data cable bundle, that includes 5 fiber bundles and one Cat6 cable. It also needs a long 
   ...
   This one is easy to miss. I am using remote KVM system for the USB signal. The one we buy is https://www.amazon.com/gp/product/B06Y632T6Y/ref=oh_aui_detailpage_o00_s00?ie=UTF8&psc=1, it does support 4k resolution, but refreshing frequency drops to 30Hz. 
