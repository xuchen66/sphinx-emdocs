...
Front and Back of controller of Orius and shutterbox of TemCam 224-HD
...
Gun Coil Current Changes When Large Screen Up (left) and Down (right)
...
4. A Note about the Temperature
...
command "ccdpshow" to get temperature for 224HD

5. Control both cameras using SerialEM
...
Camera Setup Window where one can change mag and screen position to match scope
...
7. Pixlesize Calibration for Both Cameras
